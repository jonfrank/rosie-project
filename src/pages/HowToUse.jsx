        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="space-y-6 mb-8">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1 mt-0">Print out the worksheets</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1 mt-0">Open the Classroom Materials Page</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1 mt-0">Investigate the Objects</h3>
            ...
            <div className="flex items-start space-x-4">
              <div className="flex flex-col items-center">
                ...
                <div className="text-6xl mt-2" style={{transform: 'scaleX(-1)'}}>✍🏼</div>
              </div>
              <div>
