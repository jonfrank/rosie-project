        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="space-y-6 mb-8">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">📖 Read the Teacher Guide</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">📜 Download the Object Guide</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">🖨️ Print out the worksheets</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">🖥️ Open the Classroom Materials Page</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">🚀 Session Introduction and Time Portal</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">🕵🏽‍♀️ Investigate the Objects</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">✍🏼 Activity Time</h3>
